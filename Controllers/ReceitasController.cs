...
namespace DSEB_projeto.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DataReceita,Lucro,ValorPedidos")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataReceita,Lucro,ValorPedidos")] Receita receita)
        {
            if (id != receita.Id)
            {
                return NotFound();
